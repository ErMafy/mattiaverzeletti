            ...
            <motion.div
              ...
              className={`group relative rounded-3xl overflow-hidden transition-all duration-500 flex flex-col ${
                percorso.highlight
                  ...
                  : 'bg-gray-50 border border-gray-200 hover:border-amber-300 hover:shadow-xl hover:shadow-amber-500/10'
              }`}
              ...
              <div className={`relative p-8 md:p-10 flex flex-col flex-grow ${percorso.highlight ? 'pt-16' : ''}`}>
                <div className={`flex flex-col flex-grow ${percorso.highlight ? 'text-white' : 'text-black'}`}>
                  ...
                  <motion.a
                    ...
                    className={`flex items-center justify-center gap-2 w-full py-4 rounded-xl font-bold text-base transition-all duration-300 uppercase tracking-wide ${
                      percorso.highlight
